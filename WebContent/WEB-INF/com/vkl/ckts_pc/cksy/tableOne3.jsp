...
<body onkeydown="keysDown(event)" onkeyup="keyup(event)">
	<form method="post" id="myform" action="">
		<div class="easyui-tabs" style="width: 100%; height: auto;">
			<P
				style="font-size: 14px; font-weight: bold; text-align: center; color: #003D71; height: 40px; line-height: 40px;">机动车查验申请</P>
			<div title="申请表" style="overflow: auto; padding: 0px;">
				<table width="100%" cellspacing="0" cellpadding="0">
					<tr>
						<td class="bgc"><span class="star">*</span>业务类型</td>
						<td><select class="easyui-combobox"
							style="width: 90%; height: 30px;" name="operType" id="operType"
							editable="false">
						...
						<td><input type="text" id="province" style="width: 180px"
							name="clxh" class="easyui-validatebox"
							validType="selectValid['--请选择--']" /> <!-- <input type="text" id="city" name = "clxh" style="width: 128px"
                      class="easyui-validatebox" validType="selectValid['']" /> -->
						</td>
						<td class="bgc"><span class="star">*</span>使用性质</td>
						<td><select class="easyui-combobox"
							style="width: 90%; height: 30px;" name="syxz" editable="false"
							id="syxzw">
					...
					<tr>
						...
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="clsbdh" id="clsbdh" /></td>
						<td class="bgc"><span class="star" id="hphmspan"></span>号牌号码</td>
						<td><select class="easyui-combobox"
							style="width: 40px; height: 30px;" name="xzqh" id="xzqh">
						...
						</select> <select class="easyui-combobox"
							style="width: 40px; height: 30px;" name="pinyin" id="pinyin">
						...
						</select> <input class="easyui-textbox" style="width: 40%; height: 30px;"
							name="hphm" id="hphm" value="" /> <!-- <button type="button" class="easyui-linkbutton"  data-options="iconCls:'icon-search'"   onclick="platequery();">号牌号码/识别代号查询</button> -->
						</td>
						<td class="bgc"><span class="star">*</span>号牌种类</td>
						<td><select class="easyui-combobox"
							style="width: 90%; height: 30px;" name="hpzl" editable="false"
							id="hpzl">
					...
					<tr>
						...
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="clpp1" id="clpp1" /></td>
          ...
          <td><select class="easyui-combobox" style="width:92%;  height:30px;" name="logoffCause" id="logoffCause">
              ...
              <c:forEach items="${djyy }" var="list">
                <option value="${list.dictKey}">${list.ldictionaryAbel }</option>
						...
						<td><select class="easyui-combobox"
							style="width: 28%; height: 30px;" id="csys1" name="csys1">
								<option value="">-请选择-</option>
								<c:forEach items="${csys}" var="list">
									<option value="${list.ldictionaryAbel}" class="ys">${list.ldictionaryAbel }</option>
								</c:forEach>
						</select> <select class="easyui-combobox" style="width: 28%; height: 30px;"
							id="csys2" name="csys2">
								<option value="">-请选择-</option>
								<c:forEach items="${csys}" var="list">
						...
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="hdzk" id="hdzk1" /></td>
					</tr>
					<tr>
						<td class="bgc"><span class="star"></span>车主姓名/名称</td>
						<td><input class="easyui-textbox"
							style="width: 50%; height: 30px;" name="owName" id="owName" />
						<!-- <button type="button" class="easyui-linkbutton" data-options="iconCls:'icon-cards__arrow'"  onclick="search();">证件扫描</button> --></td>
						<td class="bgc"><span class="star"></span>联系手机</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="owPhone" id="owPhone" /></td>
						<td class="bgc"><span class="star"></span>邮寄地址</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="owAddr" id="owAddr" /></td>
					</tr>
					<tr>
						<td class="bgc"><span class="star"></span>身份证号码</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="owIdentity"
							id="owIdentity" /></td>
						<td class="bgc"><span class="star"></span>邮政编码</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="owPostcode"
							id="owPostcode" /></td>
						<td class="bgc"><span class="star"></span>电子信箱</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="owEmial" id="owEmial" /></td>
					</tr>
					<tr>
						<td class="bgc">移出车辆管理所</td>
						<td colspan="5"><label style="width: 50px; height: 30px;">转入</label>
							<input class="easyui-textbox marginl20"
							style="width: 300px; height: 30px;" id="zrs" /> <label
							style="width: 50px; height: 30px;">省（自治区、直辖市）</label> <input
							class="easyui-textbox" style="width: 300px; height: 30px;"
							id="zrs" /> <label style="">（县、州）车辆管理所</label></td>
					</tr>
					<tr>
						<td class="bgc">代理人姓名/名称</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="proxyName" id="proxyName" /></td>
						<td class="bgc">联系手机</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="proxyPhone"
							id="proxyPhone" /></td>
						<td class="bgc">邮寄地址</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="proxyAddr" id="proxyAddr" /></td>
					</tr>
					<tr>
						<td class="bgc">联系电话</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="" id="lxdh" /></td>
						<td class="bgc">邮政编码</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="proxyPostcode"
							id="proxyPostcode" /></td>
						<td class="bgc">电子信箱</td>
						<td><input class="easyui-textbox"
							style="width: 90%; height: 30px;" name="proxyEmail"
							id="proxyEmail" /></td>
					</tr>
					<tr>

						<td class="bgc" colspan="6"><span
							style="color: red; margin-right: 20px; text-align: left;"
							id="hbhmts"></span> <!--  <button  type="button"   onclick="ylu();" style="width:70px; height: 30px; background:DeepSkyBlue;border-radius:10px; color:white;">保  存</button> -->
							<button type="button" class="easyui-linkbutton"
								data-options="iconCls:'icon-ruler'" onclick="ylu();"
								style="width: 70px;">保 存</button> <!-- <button  type="button" class="easyui-linkbutton" data-options="iconCls:'icon-ruler'"  onclick="dy();" style="width:110px;">受理单打印</button> -->
							<button type="button" class="easyui-linkbutton"
								data-options="iconCls:'icon-application_detail'"
								onclick="hqjdcxx();" style="width: 150px;">查询机动车基本信息</button> <!--  <button  type="button" class="easyui-linkbutton" data-options="iconCls:'icon-cards__arrow'"  onclick="gaopai();" style="width:120px;">业务材料高拍</button> -->
							<button type="button" class="easyui-linkbutton"
								data-options="iconCls:'icon-undo'" onclick="resertData()"
								style="width: 60px;">清空</button> <!-- <button  type="button" class="easyui-linkbutton" data-options="iconCls:'icon-undo'"  onclick="window.history.go(-1)" style="width:60px;">取消</button> -->
						</td>
					</tr>
				</table>
			</div>
			<div title="其他信息" style="overflow: auto; padding: 0px;">
				<table width="100%" cellspacing="0" cellpadding="0" id="hgzxx">
					<tr>
						<td class="bgc">编号</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="xh" id="xh" /></td>
						<td class="bgc">发证日期</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="fzTime" id="fzTime" /></td>
						<td class="bgc">车辆制造企业名称</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zzcmc" id="zzcmc" /></td>
					</tr>
					<tr>
						<td class="bgc"><span class="star"></span>获得方式</td>
						<td><select class="easyui-combobox"
							style="width: 80%; height: 30px;" name="getWay" editable="false"
							id="getWay">
						...
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="copyClxh" id="copyClxh" /></td>
						<td class="bgc">车辆识别代号/车架号</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="copyClsbdh"
							id="copyClsbdh" /></td>
					</tr>
					<tr>
						<td class="bgc">车身颜色</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" id="csys" /></td>
						<td class="bgc">底盘型号/底盘ID</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="dpType" id="dpType" /></td>
						<td class="bgc">底盘合格证编号</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="dpId" id="dpId" /></td>
					</tr>
					<tr>
						<td class="bgc">发动机型号</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="fdxh" id="fdxh" /></td>
						<td class="bgc">燃料种类</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="rlzl" id="rlzl" /></td>
						<td class="bgc">发动机号</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="fdjh" id="fdjh" /></td>
					</tr>
					<tr>
						<td class="bgc">功率</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="gl20" id="gl20" /></td>
						<td class="bgc">排量</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="pl" id="pl" /></td>
						<td class="bgc">排放标准</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="bfbz" id="bfbz" /></td>

					</tr>
					<tr>
						<td class="bgc">油耗</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="yh" id="yh" /></td>
						<td class="bgc">外廓尺寸</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="wkcc" id="wkcc" /></td>
						<td class="bgc">货厢内部尺寸</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="hxnbc" id="hxnbc" /></td>

					</tr>
					<tr>
						<td class="bgc">钢板弹簧片数</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="gbthps" id="gbthps" /></td>
						<td class="bgc">轮胎数</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="lts" id="lts" /></td>
						<td class="bgc">轮胎规格</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="ltgg" id="ltgg" /></td>

					</tr>
					<tr>
						<td class="bgc">轮距（前/后）</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="hl" id="hl" /></td>
						<td class="bgc">轴荷</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zh" id="zh" /></td>
						<td class="bgc">轴数</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zs" id="zs" /></td>

					</tr>
					<tr>
						<td class="bgc">轴距</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zj" id="zj" /></td>
						<td class="bgc">总质量</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zzl" id="zzl" /></td>
						<td class="bgc">转向形式</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zxxs" id="zxxs" /></td>

					</tr>
					<tr>
						<td class="bgc">整备质量</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zbzl" id="zbzl" /></td>
						<td class="bgc">额定载质量</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="hdzzl" id="hdzzl" /></td>
						<td class="bgc">载质量利用系数</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zzllyxs" id="zzllyxs" /></td>
					</tr>
					<tr>
						<td class="bgc">准牵引总质量</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zqyzl" id="zqyzl" /></td>
						<td class="bgc">半挂车鞍座最大允许总质量</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="bkazzl" id="bkazzl" /></td>
						<td class="bgc">驾驶室准乘人数</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="qpk" id="qpk" /></td>
					</tr>
					<tr>
						<td class="bgc">额定载客数</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" id="hdzk" /></td>
						<td class="bgc">最高设计车速</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zgscs" id="zgscs" /></td>
						<td class="bgc">车辆制造日期</td>
						<td><input class="easyui-textbox"
							style="width: 80%; height: 30px;" name="zzrq" id="zzrq" /></td>
...
$(function(){
	...
	//县市区 
		...
		$("#xzqh").combobox('textbox').bind('focus',function(){  
	        $('#xzqh').combobox('showPanel');  
        });  
		$("#pinyin").combobox('textbox').bind('focus',function(){  
	        $('#pinyin').combobox('showPanel');  
        }); 	
		$("#hpzl").combobox('textbox').bind('focus',function(){  
	        $('#hpzl').combobox('showPanel');  
        }); 	
		$("#csys1").combobox('textbox').bind('focus',function(){  
	        $('#csys1').combobox('showPanel');  
        }); 
		$("#csys2").combobox('textbox').bind('focus',function(){  
	        $('#csys2').combobox('showPanel');  
        }); 
		$("#csys3").combobox('textbox').bind('focus',function(){  
	        $('#csys3').combobox('showPanel');  
        }); 
		$("#operType").combobox('textbox').bind('focus',function(){  
	        $('#operType').combobox('showPanel');  
        }); 
		$("#syxzw").combobox('textbox').bind('focus',function(){  
	        $('#syxzw').combobox('showPanel');  
        });
		$("#province").combobox('textbox').bind('focus',function(){  
	        $('#province').combobox('showPanel');  
        });
})
   function keysDown(e){
...
/* $(function(){
	...
	$("#logoffCause").combobox({disabled:true}); // 初始禁用注销登记原因
	
	cllx();
	
})

$("#parentClxh").combobox({onChange:function(){
...
function ylu(){
	...
	if(cllx == null||cllx.replace(/(^\s*)|(\s*$)/g, "") == "" || cllx == "--请选择--"){
	...
	/* else{
		$("#hphmspan").html("*");
		if (validateEmpty($("#hphm").textbox("getValue"),'请输入号牌号码')){
			return;
		}
	} */
	...
	function platequery(){
		$.ajax({
			...
			data:{"clsbdh":$("#clsbdh").val(), "hphm":$("#hphm").val()}, // 号牌号码 车辆识别代号任意参数
			dataType:"text",
			success: function (data) {
				if(data=="no-login"){
					top.location="<%=request.getContextPath() %>/login.jsp"
				...
				if(json.errorCode=="0000"){
	    	        ...
	    	        $("#"+key).textbox("setValue",jsondata[key]);  //循环写入返回合格证信息
